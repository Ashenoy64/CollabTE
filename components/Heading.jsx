    ...
    <div className="flex flex-row gap-1">
      <button
        className={`p-2 h-8 object-contain ${
          editor.isActive("heading", { level: 1 }) ? "bg-slate-300" : "bg-white"
        }  rounded text-black`}
        onClick={() => {
      ...
      <button
        className={`p-2 h-8 object-contain ${
          editor.isActive("heading", { level: 2 }) ? "bg-slate-300" : "bg-white"
        }  rounded text-black`}
        onClick={() => {
      ...
      <button
        className={`p-2 h-8 object-contain ${
          editor.isActive("heading", { level: 3 }) ? "bg-slate-300" : "bg-white"
        }  rounded text-black`}
        onClick={() => {
